			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('jiaxiaocheliang','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('jiaxiaocheliang','预约')" type="success" size="mini" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">预约</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('jiaxiaocheliang','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>


							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('jiaxiaocheliang','查看评论')" type="primary" size="mini" @click="disscussListHandler(scope.row.id)">查看评论</el-button>



							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('jiaxiaocheliang','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
