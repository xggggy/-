		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"250px","padding":"0 6px","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"1px solid rgba(189, 125, 71, 1)","cursor":"pointer","padding":"0","boxShadow":"0px 2px 2px 0px rgba(189, 125, 71, 1)","margin":"0 0 10px","outline":"none","color":"rgba(189, 125, 71, 1)","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('kechengyuyue','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"1px solid rgba(189, 125, 71, 1)","cursor":"pointer","padding":"0","boxShadow":"0px 2px 2px 0px rgba(189, 125, 71, 1)","margin":"0 0 10px","outline":"none","color":"rgba(189, 125, 71, 1)","borderRadius":"30px","background":"#fff","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('kechengyuyue','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
					...
					<el-table-column :resizable='true' :sortable='false' prop="kechengtupian" width="200" label="课程图片">
						<template slot-scope="scope">
							<div v-if="scope.row.kechengtupian">
								<img v-if="scope.row.kechengtupian.substring(0,4)=='http'" :src="scope.row.kechengtupian.split(',')[0]" width="100" height="100">
          ...
          <el-table-column :resizable='true' :sortable='false'
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('kechengyuyue','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('kechengyuyue','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#fff","borderRadius":"30px","background":"rgba(189, 125, 71, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('kechengyuyue','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          kechengjieshao: row.kechengjieshao,
          addtime: row.addtime,
          sfsh: row.sfsh,
          shhf: row.shhf,
          id: row.id
