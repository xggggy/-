<template>
	<div class="addEdit-block" style="width: 100%;">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="状态" prop="zhuangtai">
          <el-input v-model="ruleForm.zhuangtai" placeholder="状态" clearable  :readonly="ro.zhuangtai"></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="状态" prop="zhuangtai">
          <el-input v-model="ruleForm.zhuangtai" placeholder="状态" readonly></el-input>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="投诉时间" prop="tousushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian">
...
export default {
	...
	created() {
		this.ruleForm.tousushijian = this.getCurDate()
	},
	methods: {
	...
	this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../ssm35i4a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
