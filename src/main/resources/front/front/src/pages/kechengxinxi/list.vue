...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"width":"100%","padding":"10px","alignItems":"center","flexWrap":"wrap","display":"flex","height":"auto"}'>
      <el-form-item :style='{"margin":"5px 10px"}'>
        ...
        <el-input v-model="formSearch.kechengmingcheng" placeholder="课程名称"></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>教练姓名</div>
        <el-input v-model="formSearch.jiaolianxingming" placeholder="教练姓名"></el-input>
      </el-form-item>
	...
	<div class="list" :style='{"margin":"0 0 10px"}'>
		...
		<div class="list2 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","display":"flex","height":"auto"}'>
          ...
          <img :style='{"width":"100%","objectFit":"cover","borderRadius":"8px","display":"block","height":"275px"}' v-if="item.kechengtupian && item.kechengtupian.substr(0,4)=='http'" :src="item.kechengtupian" class="image" />
          <img :style='{"width":"100%","objectFit":"cover","borderRadius":"8px","display":"block","height":"275px"}' v-else :src="baseUrl + (item.kechengtupian?item.kechengtupian.split(',')[0]:'')" class="image" />
