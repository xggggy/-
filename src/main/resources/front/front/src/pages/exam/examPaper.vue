...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"rgba(189, 125, 71, 1)","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    <div class="section-title" :style='{"padding":"16px 0","margin":"20px 0","borderColor":"rgba(189, 125, 71, 1)","color":"rgba(189, 125, 71, 1)","borderRadius":"8px","textAlign":"center","background":"rgba(189, 125, 71, 1)","borderWidth":"4px","fontSize":"24px","lineHeight":"1.5","borderStyle":"dashed dotted solid double"}'>笔试考试</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
