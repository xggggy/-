...
<div class="center-preview" :style='{"width":"1200px","margin":"10px auto","position":"relative","background":"none"}'>
	<div class="title" :style='{"padding":"16px 0","margin":"20px 0","borderColor":"rgba(189, 125, 71, 1)","color":"#fff","borderRadius":"8px","textAlign":"center","background":"rgba(189, 125, 71, 1)","borderWidth":"4px","fontSize":"24px","lineHeight":"1.5","borderStyle":"dashed dotted solid double"}'>{{ title }}</div>

    <el-tabs tab-position="left" :style='{"boxShadow":"0 2px 4px rgba(0,0,0,.1)","padding":"12px 0 0","margin":"20px 0 40px","borderColor":"rgba(189, 125, 71, 1)","borderRadius":"8px","background":"#f5f5f5","borderWidth":"4px","borderStyle":"dashed dotted solid double"}' @tab-click="handleClick">
        ...
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xueyuan'" label="头像">
            <el-upload
              ...
              <img :style='{"border":"1px dashed rgba(189, 125, 71, 1)","cursor":"pointer","boxShadow":"rgba(189, 125, 71, 1)rgba(189, 125, 71, 1)","color":"rgba(189, 125, 71, 1)","borderRadius":"6px","textAlign":"center","width":"200px","fontSize":"32px","lineHeight":"120px","height":"auto"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
          ...
          <el-form-item :style='{"padding":"0","margin":"0"}'>
            ...
            <el-button :style='{"border":"1px solid rgba(189, 125, 71, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"rgba(189, 125, 71, 1)","borderRadius":"4px","background":"#ecfaea","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="danger" @click="logout">退出登录</el-button>
          </el-form-item>
        </el-form>
      ...
      <el-tab-pane label="课程预约"></el-tab-pane>
      <el-tab-pane label="车辆预约"></el-tab-pane>
      <el-tab-pane label="消息通知"></el-tab-pane>
      <el-tab-pane label="投诉信息"></el-tab-pane>
      <el-tab-pane label="缴费信息"></el-tab-pane>
      ...
      handleClick(tab, event) {
        switch(event.target.outerText) {
          ...
          case '错题本':
            ...
            break;
          case '课程预约':
            tab.$router.push('/index/kechengyuyueList');
            break;
          case '车辆预约':
            tab.$router.push('/index/yuyuexinxiList');
            break;
          case '消息通知':
            tab.$router.push('/index/tongzhixinxiList');
            break;
          case '投诉信息':
            tab.$router.push('/index/tousuxinxiList');
            break;
          case '缴费信息':
            tab.$router.push('/index/jiaofeixinxiList');
            break;
          case '我的收藏':
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .center-preview-pv /deep/ .avatar-uploader-icon {
  	border: 1px dashed rgba(189, 125, 71, 1);
  	cursor: pointer;
  	border-radius: 6px;
  	box-shadow: rgba(189, 125, 71, 1)rgba(189, 125, 71, 1);
  	color: rgba(189, 125, 71, 1);
