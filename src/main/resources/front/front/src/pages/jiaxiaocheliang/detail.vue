	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"20px auto 0","position":"relative"}'>
		<div class="attr" :style='{"padding":"20px","borderColor":"rgba(189, 125, 71, 1)","borderRadius":"12px","flexWrap":"wrap","background":"#fff","borderWidth":"3px","display":"flex","position":"relative","borderStyle":"dotted dashed solid double","justifyContent":"center"}'>
			...
			<div class="info" :style='{"width":"50%","padding":"10px","margin":"0 2% 0 0px","background":"#fff","order":"2"}'>
				<div class="item" :style='{"border":"1px solid rgba(189, 125, 71, 1)","padding":"6px 10px","boxShadow":"rgba(189, 125, 71, 1)","margin":"0 0 10px 0","alignItems":"center","borderRadius":"4px","background":"#fff","display":"flex","justifyContent":"space-between"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"radial-gradient(circle, rgba(189, 125, 71, 1) 0%, rgba(189, 125, 71, 1) 81%, rgba(189, 125, 71, 1) 100%)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('jiaxiaocheliang','预约')" @click="onAcross('yuyuexinxi','','','')" type="warning">预约</el-button>
				</div>
			</div>
